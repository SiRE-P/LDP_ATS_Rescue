...
parse_target_dat <- function(file_path) {
...
data_dir <- "C:/DFO-MPO/OneDrive/OneDrive - DFO-MPO/PROJECTS/LDP - Living_Data_Project/ATS Rescue/3_Data/1_In_Process/1_ACOUSTIC_TARGETS/"
file_path <- paste(data_dir, "TARGET01.DAT", sep="")
...
write.csv(all_targets, "all_targets_clean_combined.csv", row.names = FALSE)
