...
```{r trip-effort-lakes, fig.cap="Frequency distribution of ATS trips by month and ATS year across the lakes of interest.", fig.width=8, out.width="100%", fig.asp = 11.69/8.27}
...
```{r trip-effort-Meziadin, fig.cap="Frequency distribution of ATS trips by month and ATS year across the lakes of interest.", fig.width=7, fig.height=2.5, out.width="100%"}
