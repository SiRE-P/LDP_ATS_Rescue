...
if (!dir.exists("./ACOUSTIC_TARGETS/output/figures")) {dir.create("./figures")}         # ensure plot output directory exists
if (!dir.exists("./ACOUSTIC_TARGETS/output/ARCHIVE")) 
    {dir.create("./ACOUSTIC_TARGETS/output/ARCHIVE")}  # ensure archive directory exists for storing date-stamped copy of output
...
# Export to CSV
write_csv(target_data_exact_duplicates, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_CHK_exact_duplicate_records_", ats_year_span, date_stamp, ".csv", sep=""))
write_csv(target_data_exact_duplicates, paste("./ACOUSTIC_TARGETS/output/Target_CHK_exact_duplicate_records_", ats_year_span, ".csv"     , sep="")) # save copy for import to Pivot workbook
...
write.csv(target_data_keyfield_duplicates, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_CHK_keyfield_duplicate_surveys_", ats_year_span, date_stamp, ".csv", sep=""), row.names = FALSE) 
write.csv(target_data_keyfield_duplicates, paste("./ACOUSTIC_TARGETS/output/Target_CHK_keyfield_duplicate_surveys_", ats_year_span,                     ".csv", sep=""), row.names = FALSE) # dump out a generic version that is auto-read by Excel PIVOT version
...
write_csv(lake_sequential_survey_data, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_CHK_sequential_surveys_", ats_year_span, date_stamp, ".csv", sep=""))
write.csv(lake_sequential_survey_data, paste("./ACOUSTIC_TARGETS/output/Target_CHK_sequential_surveys_", ats_year_span,                     ".csv", sep=""), row.names = FALSE) # dump out a generic version that is auto-read by Excel PIVOT version
...
cat("\n")
write_csv(range_issues, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_CHK_targets_issues_", ats_year_span, date_stamp, ".csv", sep=""))
write_csv(range_issues, paste("./ACOUSTIC_TARGETS/output/Target_CHK_targets_issues_", ats_year_span, ".csv", sep=""))
...
write_csv(acoustic_target_final_data, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_OUTPUT_data_FINAL_", ats_year_span, date_stamp, ".csv", sep=""))
write_csv(acoustic_target_final_data, paste("./ACOUSTIC_TARGETS/output/Target_OUTPUT_data_FINAL_", ats_year_span, ".csv",      sep="")) # export copy for PIVOT workbook
...
write_csv(acoustic_target_final_inventory, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_OUTPUT_data_INVENTORY_", ats_year_span, date_stamp, ".csv", sep=""))
write_csv(acoustic_target_final_inventory, paste("./ACOUSTIC_TARGETS/output/Target_OUTPUT_data_INVENTORY_", ats_year_span, ".csv",      sep="")) # export copy for PIVOT workbook
...
write_csv(combined_raw_and_final, paste("./ACOUSTIC_TARGETS/output/ARCHIVE/Target_CHK_RAW_vs_CLEAN_surveys_", ats_year_span, date_stamp, ".csv", sep=""))
write_csv(combined_raw_and_final, paste("./ACOUSTIC_TARGETS/output/Target_CHK_RAW_vs_CLEAN_surveys_", ats_year_span, ".csv", sep=""))
...
plotfile <- paste0("./ACOUSTIC_TARGETS/output/figures/Acoustic_Survey_Freq_by_Lake_Year_", ats_year_span, ".pdf")
