...
In other words, the numbering restarts for each combination of trawl_number, species_common_name, and life_stage for a given lake_name and trawl_date, and ranges from 1 to *fish_total* for that combination of species_common_name, and life_stage, for a given trawl_number.
...
Three weight records were misplaced in this columns and transferred to the correct columns. It is flagged in the "data_issues" column as a scale_book_comment: "Weight value was incorrectly recorded in the scale_book field; corrected by re-coding to 0." Any "999" code was replaced by NA.
...
-   scale_book_issues: Flags modifications in the scale_book field or stores unprocessed general comments associated with scale_book records from the original files.
